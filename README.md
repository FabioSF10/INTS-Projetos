# 🏥 INTS - Ecossistema de Automação e Infraestrutura

Este repositório centraliza as soluções, scripts e ferramentas desenvolvidas para otimizar a operação de TI no **Hospital INTS**. O foco é aplicar mentalidade de **FinOps** e **Automação** para reduzir custos operacionais e elevar a eficiência da infraestrutura hospitalar.
...
---
> *"Transformando infraestrutura reativa em automação proativa."*
> **Autor:** Fabio Stefano - T.I. INTS
